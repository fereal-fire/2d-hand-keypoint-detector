...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/annotations/synthmocap_train.json',
        img_prefix=f'{data_root}/synth_hand/',
        data_cfg=data_cfg,
        pipeline=train_pipeline,
        dataset_info={{_base_.dataset_info}}),
    val=dict(
        type='SynthMocapHandDataset',
        ann_file=f'{data_root}/annotations/synthmocap_val.json',
        img_prefix=f'{data_root}/synth_hand/',
        data_cfg=data_cfg,
