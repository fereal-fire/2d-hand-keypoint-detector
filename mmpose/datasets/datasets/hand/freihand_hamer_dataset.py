...
class FreihandHamerHandDataset(Kpt2dSviewRgbImgTopDownDataset):
    """Freihand Hamer dataset for top-down hand pose estimation.
    The dataset loads raw features and apply specified transforms
    to return a dict containing the image tensors and other information.

    Freihand Hamer Hand keypoint indexes::
