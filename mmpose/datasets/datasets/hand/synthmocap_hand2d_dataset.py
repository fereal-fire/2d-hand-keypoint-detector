...
class SynthMocapHandDataset(Kpt2dSviewRgbImgTopDownDataset):
    """SynthoMoCap dataset for top-down hand pose estimation.
    The dataset loads raw features and apply specified transforms
    to return a dict containing the image tensors and other information.

    SynthMoCap Hand keypoint indexes::
    ...
    def __init__(self,
        ...
        if dataset_info is None:
            ...
            cfg = Config.fromfile(
                'configs/_base_/datasets/synthmocap_hand.py')
